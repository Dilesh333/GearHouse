    ...
    <div className="mt-10 max-w-6xl mx-auto mb-5 px-4 md:px-0 ">
      {cartItem.length > 0 ? (
          ...
          <div>
              ...
              {cartItem.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <div className="bg-blue-500 text-white flex gap-4 p-2 rounded-md text-xl">
                    ...
                    <span onClick={()=>deleteItem(item.id)} className="hover:bg-white/60 trsnsition-all p-3 hover:shadow-2xl rounded-full">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 md:gap-20 ">
              <div className="bg-gray-100 rounded-md p-7 mt-4 space-y-2">
                <h1 className="text-800 font-bold text-xl">Delivery Info</h1>
                ...
                <button className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white px-3 py-1 rounded-md mt-3 cursor-pointer">
                  Submit
                </button>
                ...
                <div className="flex justify-center">
                  <button onClick={getLocation} className="bg-blue-500 text-white px-3 py-2 rounded-md">
                    Detect Loaction
                  </button>
                </div>
              </div>
              <div className="bg-white border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max">
                ...
                <div>
                  <button className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white w-full px-3 py-2 rounded-md cursor-pointer mt-3">
                  Proceed to Checkout
                </button>
                </div>
              </div>
        ...
        <div className="flex flex-col gap-3 justify-center items-center h-[600px]">
          ...
          <button onClick={()=>navigate('/products')} className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white px-3 py-2 rounded-md cursor-pointer">Continue Shopping</button>
        </div>
      )}
    </div>
  );
